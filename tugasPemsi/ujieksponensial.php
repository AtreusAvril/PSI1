...
<div class="judul text-center mt-5">
    <h1>Uji Eksponensial <small class="text-muted"></small></h1>
</div>
                ...
                <form action="" method="post">
                    <div class="row">
                        <div class="col-6 pb-3">
                            <input type="text" class="form-control" placeholder="Nilai lambda" name="nilai-theta" required>
                        </div>
                    </div>

                    <?php if(isset($_POST['nilai-theta'])): ?>
                    ...
                    <?php endif; ?>
                    <input type="text" name="algoritma" value="algo-eksponensial" hidden>
            ...
            <table class="table table-striped">
                ...
                ?>
                    <tr>
                        ...
                        <?php if($_POST['algoritma']=='algo-eksponensial'): ?>
                            <td>
                                <?php $xSekarang = eksponensial($_POST['nilai-theta']);
                                $kumpulanX[] = (String) number_format($xSekarang, 2, '.', '');
                                echo number_format($xSekarang, 2, '.', '')?>
                            </td>
                        <?php endif; ?>
