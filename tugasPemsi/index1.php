<?php
    ...
    if (isset($_POST['tampilkan'])){
            ...
            for($i = 0; $i < $percobaan; $i++){
                $arrayHasil = topik35_1($tfinal,$s,$q);
...
<div class="judul text-center mt-5">
    <h1>UTS Topik 35 <small class="text-muted">(Dist 2)</small></h1>
</div>
                ...
                <label for="">,</label>
                    <div class="row">
                        <div class="col-12 pb-3">
                            <input type="text" class="form-control" placeholder="Nilai lambda" name="lambda" required>
                            <input type="text" class="form-control" placeholder="Nilai n" name="n" required>
                            <input type="text" class="form-control" placeholder="Nilai p" name="p" required>
                        </div>
                    </div>
